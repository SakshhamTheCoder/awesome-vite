...
- [react-jsx-pwa-starter](https://github.com/SakshhamTheCoder/react-jsx-pwa-starter) - Minimal PWA starter template with `React`, `Vite`, `TailwindCSS`, `React-Router`, `Axios` in JavaScript.
